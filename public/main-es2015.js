...
class User {
    constructor(customerID, firstName, lastName, birthday, gender) {
...
let AddCustComponent = class AddCustComponent {
    ...
    createUser() {
        ...
        this.userService.createUser(this.user).subscribe(user => alert(`A new user was created with an id: ${user.customerID}`), err => alert(`Got an error as : ${err}`), () => alert(`Creation of user completed`));
    }
};
AddCustComponent.ctorParameters = () => [
...
let CustSubNavComponent = class CustSubNavComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let DeleteCustComponent = class DeleteCustComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let UpdateCustComponent = class UpdateCustComponent {
...
UpdateCustComponent.ctorParameters = () => [
...
let UserDetailsComponent = class UserDetailsComponent {
    ...
    updateUser() {
        this.userService.updateUser(this.user).subscribe(user => alert(`A new user was updated`), err => alert(`Got an error as : ${err}`), () => alert(`Updation of user completed`));
    }
    deleteUser() {
        this.userService.deleteUser(this.user.customerID).subscribe(user => alert(`A new user was created with an id: ${user.customerID}`), err => alert(`Got an error as : ${err}`), () => alert(`Deletion of user completed`));
    }
};
